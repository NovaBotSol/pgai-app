...
const LandingPage: React.FC = () => {
  ...
  const FeatureCard: React.FC<FeatureCardProps> = ({ title, description, icon }) => (
    <div className="relative group p-8 rounded-2xl">
      <div className="absolute inset-0 bg-gray-800/50 rounded-2xl backdrop-blur-lg group-hover:bg-purple-900/60 transform transition-all duration-500 border border-gray-700/50 group-hover:border-purple-500/50 shadow-lg group-hover:shadow-purple-500/20"></div>
  ...
  const TokenCard: React.FC<TokenCardProps> = ({ title, description }) => (
    <div className="group bg-gray-800/50 p-8 rounded-2xl backdrop-blur-lg hover:bg-purple-900/60 transform transition-all duration-300 hover:scale-105 border border-gray-700/50 hover:border-purple-500/50 shadow-lg hover:shadow-purple-500/20 text-center">
      <div className="mb-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-gray-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <a 
              ...
              className="text-white hover:text-purple-400 transition-colors duration-300 font-semibold"
            >
              Buy $PGAI
            </a>
            ...
            <div className="flex items-center space-x-6">
              <span className="text-white mr-4">Join PGAI Community</span>
              <a 
                href="https://x.com/promptgamesai" 
                target="_blank" 
                rel="noopener noreferrer" 
      ...
      <div className="relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(120,0,255,0.15),transparent_50%)] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="text-center mb-24 relative">
            ...
            <div className="mb-12 max-w-2xl mx-auto">
              <HoverText>
                Transform Your Ideas Into Games and Earn With $PGAI
              </HoverText>
            </div>
            <button 
              onClick={() => window.location.href = '/generate'} 
              className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 hover:scale-105"
            >
              Start Creating
            </button>
          </div>
          ...
          <div className="flex gap-8 mb-24 px-8 pb-4">
            ...
            <div className="w-1/3">
              <FeatureCard
                ...
                icon={<Coins className="w-16 h-16 text-purple-400" />}
              />
            </div>
            <div className="w-1/3">
              <FeatureCard
          ...
          <div className="max-w-4xl mx-auto mb-24">
            ...
            <div className="bg-gray-800/50 p-10 rounded-2xl backdrop-blur-lg hover:bg-purple-900/60 transform transition-all duration-300 hover:scale-105 border border-gray-700/50 hover:border-purple-500/50 shadow-lg hover:shadow-purple-500/20">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <HoverText variant="h2">$PGAI Token Utility</HoverText>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <TokenCard
                title="In-Game Currency"
                description="$PGAI serves as the foundation for all in-game transactions and marketplace activities"
              />
              <TokenCard
                title="Creator Earnings"
                description="Monetize your games through sales and earn $PGAI from every in-game transaction"
              />
              <TokenCard
              ...
              <TokenCard
                ...
                description="PGAI team takes 10% of all revenue generated, 5% supports platform development & 5% is automatically burned"
              />
            </div>
          </div>
        </div>
